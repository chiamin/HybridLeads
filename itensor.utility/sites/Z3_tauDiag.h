...
//
#ifndef __ITENSOR_Z3_TAUDIAG_H
#define __ITENSOR_Z3_TAUDIAG_H
#include "itensor/mps/siteset.h"
#include "itensor/util/str.h"

namespace itensor {

class Z3_tauDiagSite;

using Z3_tauDiag = BasicSiteSet<Z3_tauDiagSite>;
...
class Z3_tauDiagSite
    ...
    Z3_tauDiagSite(Index I) : s(I) { }

    Z3_tauDiagSite(Args const& args = Args::global())
        {
    ...
    Z3_tauDiagSite(int n, Args const& args = Args::global())
        {
        *this = Z3_tauDiagSite({args,"SiteNumber=",n});
        }
