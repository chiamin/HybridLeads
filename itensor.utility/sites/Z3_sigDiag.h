...
//
#ifndef __ITENSOR_Z3_SIGDIAG_H
#define __ITENSOR_Z3_SIGDIAG_H
#include "itensor/mps/siteset.h"
#include "itensor/util/str.h"

namespace itensor {

class Z3_sigDiagSite;

using Z3_sigDiag = BasicSiteSet<Z3_sigDiagSite>;
...
class Z3_sigDiagSite
    ...
    Z3_sigDiagSite(Index I) : s(I) { }

    Z3_sigDiagSite(Args const& args = Args::global())
        {
    ...
    Z3_sigDiagSite(int n, Args const& args = Args::global())
        {
        *this = Z3_sigDiagSite({args,"SiteNumber=",n});
        }
