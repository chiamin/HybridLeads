    ...
    if (systype == "SC_scatter") {
      if (in_scatter) {
        s = Index(QN({"Nf", 0, -1}, {"Ps", 0, -2}), 1,
                  QN({"Nf", 0, -1}, {"Ps", 1, -2}), 1, Out, ts);
      } else {
        s = Index(QN({"Nf", 0, -1}, {"Ps", 0, -2}), 1,
                  QN({"Nf", 1, -1}, {"Ps", 0, -2}), 1, Out, ts);
      }
    } else if (systype == "Normal") {
      if (in_scatter) {
        s = Index(QN({"Nf", 0, -1}, {"Ns", 0, -1}), 1,
                  QN({"Nf", 1, -1}, {"Ns", 1, -1}), 1, Out, ts);
      } else {
        s = Index(QN({"Nf", 0, -1}, {"Ns", 0, -1}), 1,
                  QN({"Nf", 1, -1}, {"Ns", 0, -1}), 1, Out, ts);
      }
    } else if (systype == "SC_Josephson_scatter") {
      if (in_scatter) {
        s = Index(QN({"Pf", 0, -2}, {"Ps", 0, -2}), 1,
                  QN({"Pf", 0, -2}, {"Ps", 1, -2}), 1, Out, ts);
      } else {
        s = Index(QN({"Pf", 0, -2}, {"Ps", 0, -2}), 1,
                  QN({"Pf", 1, -2}, {"Ps", 0, -2}), 1, Out, ts);
      }
    } else {
