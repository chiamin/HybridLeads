...
void apply_Heff (const ITensor& LW, const ITensor& RW, const ITensor& W, ITensor& AC, ITensor& C)
{
...
void solve_gs (const ITensor& LW, const ITensor& RW, const ITensor& W, ITensor& AC, ITensor& C, const Args& args=Args::global())
...
void time_evolve (const ITensor& LW, const ITensor& RW, const ITensor& W, ITensor& AC, ITensor& C, TimeType dt,
